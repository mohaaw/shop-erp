import { getPurchaseInvoicesAction } from '@/app/actions/purchase-invoice-actions';
...
export default async function PurchaseInvoicesPage() {
    const invoices = await getPurchaseInvoicesAction();
                            ...
                            {invoices.length === 0 ? (
                                ...
                                invoices.map((invoice) => (
                                    <TableRow key={invoice.id}>
                                        ...
                                        <TableCell className="text-right">
                                            <Link href={`/dashboard/finance/purchase-invoices/${invoice.id}`}>
